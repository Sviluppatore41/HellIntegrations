package foxiwhitee.HellIntegrations.asm.draconic;

import foxiwhitee.HellIntegrations.utils.asm.ASMUtils;
import foxiwhitee.HellIntegrations.utils.asm.ComputeFramesClassWriter;
...
public class DraconicTransformer {
    ...
    public static byte[] transformDraconicBlock(byte[] basicClass) {
        try {
            ...
            String customClassPath = "foxiwhitee/HellIntegrations/integration/draconic/blocks/DraconicBlock.class";
    ...
    public static byte[] transformMinecraft(byte[] basicClass) {
        ...
        classNode.interfaces.add("foxiwhitee/HellIntegrations/integration/draconic/helpers/gui/accessors/IMinecraftAccessor");
