package foxiwhitee.HellIntegrations.asm.ic2;
...
public class IC2Transformer {
    ...
    public static byte[] transformTileEntityPatternStorage(byte[] basicClass) {
        ...
        hook.add(new MethodInsnNode(INVOKESTATIC, "foxiwhitee/HellIntegrations/asm/ic2/IC2Hooks", "onPatternAdded", "(Lic2/core/block/machine/tileentity/TileEntityPatternStorage;)V", false));
