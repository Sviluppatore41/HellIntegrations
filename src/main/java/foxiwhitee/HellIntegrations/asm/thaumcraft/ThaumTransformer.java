package foxiwhitee.HellIntegrations.asm.thaumcraft;
...
import static foxiwhitee.HellIntegrations.utils.asm.ASMUtils.*;
...
public class ThaumTransformer {
    ...
    public static byte[] transformInfusionMatrix(byte[] basicClass) {
        ...
        String thisFile = "foxiwhitee/HellIntegrations/asm/thaumcraft/asm/ThaumHooks";
