...
import foxiwhitee.HellIntegrations.client.gui.GuiCobblestoneDuper;
...
public class BlockCobblestoneDuper extends AEBaseBlock implements ITileEntityProvider {
    ...
    public void registerBlockIcons(IIconRegister register) {
        this.icons[0] = register.registerIcon( HellCore.MODID.toLowerCase() + ":ae2/cobblestone_duper/" + name + "_top");
        this.icons[2] = register.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/cobblestone_duper/" + name + "_bottom");
        this.icons[1] = register.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/cobblestone_duper/" + name + "_side");
    }
