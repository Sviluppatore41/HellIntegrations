...
import foxiwhitee.HellIntegrations.tile.wireless.*;
...
public class BlockCustomWireless extends AEBaseBlock implements ITileEntityProvider {
    ...
    public void registerBlockIcons(IIconRegister iconRegistry) {
        this.icons[0] = iconRegistry.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/wireless/" + name + "_side_off");
        this.icons[1] = iconRegistry.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/wireless/" + name + "_top_off");
        this.icons[2] = iconRegistry.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/wireless/" + name + "_side_on");
        this.icons[3] = iconRegistry.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/wireless/" + name + "_top_on");
    }
