...
public class BlockCustomCraftingStorage extends BlockCraftingUnit {
    ...
    public void registerBlockIcons(IIconRegister iconRegistry) {
        icons[0] = iconRegistry.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/blockCraftingStorages/" + name);
        icons[1] = iconRegistry.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/blockCraftingStorages/" + name + "Fit");
    }
