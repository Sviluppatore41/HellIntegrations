package foxiwhitee.HellIntegrations.blocks.interfaces;
...
import foxiwhitee.HellIntegrations.client.render.RenderAdvancedBlockInterface;
...
public class BlockAdvancedInterface extends BlockInterface {
    ...
    protected String getTextureName() {
        return HellCore.MODID.toLowerCase() + ":ae2/" + this.getUnlocalizedName().replace("tile.", "");
    }
    ...
    public void registerBlockIconsSpecial(IIconRegister register) {
        this.icons[0] = register.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/advanced_interface");
        this.icons[1] = register.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/advanced_interface_alternate");
        this.icons[2] = register.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/advanced_interface_alternate_arrow");
    }
