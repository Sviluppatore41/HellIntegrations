...
public class BlockHybridInterface extends BlockAdvancedInterface {
    ...
    public void registerBlockIconsSpecial(IIconRegister register) {
        this.icons[0] = register.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/hybrid_interface");
        this.icons[1] = register.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/hybrid_interface_alternate");
        this.icons[2] = register.registerIcon(HellCore.MODID.toLowerCase() + ":ae2/hybrid_interface_alternate_arrow");
    }
}
