...
import foxiwhitee.HellIntegrations.client.gui.buttons.CustomGuiTabButton;
...
import foxiwhitee.HellIntegrations.network.packets.DefaultPacket;
import foxiwhitee.HellIntegrations.utils.craft.IGuiMEMonitorableAccessor;
...
public class GuiTerminal extends AEBaseMEGui implements ISortSource, IConfigManagerHost, IGuiMEMonitorableAccessor {
    ...
    protected ResourceLocation getBackgroundLocation() {
        return new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/" + getBackground());
    }
    ...
    public void bindTexture(String file) {
        ResourceLocation loc = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/" + file);
