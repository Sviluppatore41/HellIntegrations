package foxiwhitee.HellIntegrations.client.render;
...
public class RenderBlockAdvancedDriver extends TileEntitySpecialRenderer {
    private static final ResourceLocation TOP_TEXTURE = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/blocks/ae2/advancedDriver.png");
    private static final ResourceLocation BOTTOM_TEXTURE = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/blocks/ae2/advancedDriverBottom.png");
    private static final ResourceLocation SIDE_TEXTURE = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/blocks/ae2/advancedDriverSide.png");
    private static final ResourceLocation FRONT_TEXTURE = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/blocks/ae2/advancedDriverFront.png");
    @Override
