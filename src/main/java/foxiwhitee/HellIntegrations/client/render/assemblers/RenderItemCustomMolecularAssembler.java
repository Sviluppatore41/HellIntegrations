...
public abstract class RenderItemCustomMolecularAssembler implements IItemRenderer {
    ...
    private final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(HellCore.MODID.toLowerCase(), "models/molecular_assembler_interface.obj"));
