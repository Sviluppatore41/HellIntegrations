package foxiwhitee.HellIntegrations.container.slots;
...
import foxiwhitee.HellIntegrations.integration.botania.items.ae.ItemUpgradeFlowerSynthesizer;
import foxiwhitee.HellIntegrations.integration.botania.items.generating.ItemCoreOfLife;
import foxiwhitee.HellIntegrations.integration.botania.items.generating.ItemEssenceOfLife;
import foxiwhitee.HellIntegrations.integration.botania.items.generating.ItemUpgradeGeneratorMultiply;
import foxiwhitee.HellIntegrations.integration.botania.items.generating.ItemUpgradeGeneratorSpeed;
import foxiwhitee.HellIntegrations.integration.ic2.helpers.ISpecialSintezatorPanel;
import foxiwhitee.HellIntegrations.integration.ic2.items.ItemEUEnergyUpgrades;
import foxiwhitee.HellIntegrations.integration.ic2.items.ItemSunUpgrade;
