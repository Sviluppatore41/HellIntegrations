package foxiwhitee.HellIntegrations.integration.avaritia;
...
import foxiwhitee.HellIntegrations.integration.avaritia.blocks.BlockNeutronUnifier;
...
import foxiwhitee.HellIntegrations.integration.avaritia.container.ContainerPartCraftingTerminal9x9;
...
import foxiwhitee.HellIntegrations.integration.avaritia.blocks.BlockCustomNeutronCollector;
import foxiwhitee.HellIntegrations.integration.avaritia.items.*;
import foxiwhitee.HellIntegrations.integration.avaritia.parts.PartBigProcessingPatternTerminal;
...
public class AvaritiaIntegration implements IIntegration {
    ...
    public void preInit(FMLPreInitializationEvent paramFMLPreInitializationEvent) {
        ...
        if (ContentConfig.enableCollectors) {
            ...
            RegisterUtils.findClasses("foxiwhitee.HellIntegrations.integration.avaritia.tile.collectors", TileEntity.class).forEach(RegisterUtils::registerTile);
        }
