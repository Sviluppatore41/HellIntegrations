...
import foxiwhitee.HellIntegrations.integration.avaritia.tile.collectors.TileCustomNeutronCollector;
...
public class GuiCustomNeutronCollector extends GuiContainer {
    ...
    public GuiCustomNeutronCollector(ContainerCustomNeutronCollector container) {
        ...
        this.ySize = 200;
        this.xSize = 210;
        TEXTURE = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/gui/gui_" + this.tile.getName() + ".png");
    }
