...
import foxiwhitee.HellIntegrations.client.gui.terminals.GuiTerminal;
...
public class GuiPartCraftingTerminal9x9 extends GuiTerminal {
    ...
    public void drawBG(int offsetX, int offsetY, int mouseX, int mouseY) {
        (Minecraft.getMinecraft()).renderEngine.bindTexture(new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/gui/gui_terminal_avaritia_craft_big.png"));
