package foxiwhitee.HellIntegrations.integration.botania;
...
import foxiwhitee.HellIntegrations.blocks.BlockAENetwork;
...
import foxiwhitee.HellIntegrations.integration.botania.blocks.*;
import foxiwhitee.HellIntegrations.integration.botania.client.ManaPoolInfoRenderer;
import foxiwhitee.HellIntegrations.integration.botania.client.render.pools.RenderCustomManaPool;
import foxiwhitee.HellIntegrations.integration.botania.client.render.spreaders.RenderCustomSpreader;
import foxiwhitee.HellIntegrations.integration.botania.client.render.RenderItemManaCharger;
import foxiwhitee.HellIntegrations.integration.botania.client.render.RenderManaCharger;
import foxiwhitee.HellIntegrations.integration.botania.client.render.entity.RenderCustomSpark;
import foxiwhitee.HellIntegrations.integration.botania.container.*;
import foxiwhitee.HellIntegrations.integration.botania.entity.AsgardSpark;
import foxiwhitee.HellIntegrations.integration.botania.entity.HelhelmSpark;
import foxiwhitee.HellIntegrations.integration.botania.entity.MidgardSpark;
import foxiwhitee.HellIntegrations.integration.botania.entity.ValhallaSpark;
import foxiwhitee.HellIntegrations.integration.botania.event.ServerEventHandler;
import foxiwhitee.HellIntegrations.integration.botania.helpers.IManaStorageGrid;
import foxiwhitee.HellIntegrations.integration.botania.items.*;
import foxiwhitee.HellIntegrations.integration.botania.items.ae.*;
import foxiwhitee.HellIntegrations.integration.botania.items.generating.*;
import foxiwhitee.HellIntegrations.integration.botania.items.patterns.*;
import foxiwhitee.HellIntegrations.integration.botania.me.CreativeManaCellHandler;
import foxiwhitee.HellIntegrations.integration.botania.me.ManaCellHandler;
import foxiwhitee.HellIntegrations.integration.botania.me.ManaStorageGrid;
import foxiwhitee.HellIntegrations.integration.botania.parts.*;
import foxiwhitee.HellIntegrations.integration.botania.tile.*;
import foxiwhitee.HellIntegrations.integration.botania.tile.ae.*;
import foxiwhitee.HellIntegrations.integration.botania.tile.ae.ports.TileManaReceiver;
import foxiwhitee.HellIntegrations.integration.botania.tile.ae.ports.TileManaReceiverDwimerite;
import foxiwhitee.HellIntegrations.integration.botania.tile.ae.ports.TileManaSupplier;
import foxiwhitee.HellIntegrations.integration.botania.tile.ae.ports.TileManaSupplierDwimerite;
import foxiwhitee.HellIntegrations.integration.botania.tile.pools.*;
import foxiwhitee.HellIntegrations.integration.botania.tile.spreaders.*;
...
public class BotaniaIntegration implements IIntegration {
    ...
    public void preInit(FMLPreInitializationEvent e) {
        ...
        if (ContentConfig.enablePools) {
            ...
            RegisterUtils.findClasses("foxiwhitee.HellIntegrations.integration.botania.tile.pools", TileEntity.class).forEach(RegisterUtils::registerTile);
        }
        if (ContentConfig.enableSpreaders) {
            ...
            RegisterUtils.findClasses("foxiwhitee.HellIntegrations.integration.botania.tile.spreaders", TileEntity.class).forEach(RegisterUtils::registerTile);
        }
        ...
        if (ContentConfig.enableMEMana) {
            ...
            RegisterUtils.findClasses("foxiwhitee.HellIntegrations.integration.botania.tile.ae.ports", TileEntity.class).forEach(RegisterUtils::registerTile);
            ...
            if (ContentConfig.enableManaGenerator) {
                ...
                RegisterUtils.findClasses("foxiwhitee.HellIntegrations.integration.botania.tile.ae", TileManaGenerator.class).forEach(RegisterUtils::registerTile);
