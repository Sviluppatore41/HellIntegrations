package foxiwhitee.HellIntegrations.integration.botania.client;
...
import foxiwhitee.HellIntegrations.utils.coord.BlockPos;
...
public class ManaPoolInfoRenderer {
    ...
    public static final ResourceLocation info_texture = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/gui/info.png");
