package foxiwhitee.HellIntegrations.integration.botania.client.render;

import foxiwhitee.HellIntegrations.HellCore;
import foxiwhitee.HellIntegrations.integration.botania.client.model.ModelCharger;
import foxiwhitee.HellIntegrations.integration.botania.tile.TileManaCharger;
...
public class RenderManaCharger extends TileEntitySpecialRenderer {
    ...
    public static ResourceLocation TEXTURE_CHARGER = new ResourceLocation(HellCore.MODID.toLowerCase() + ":textures/blocks/botania/manaCharger.png");
