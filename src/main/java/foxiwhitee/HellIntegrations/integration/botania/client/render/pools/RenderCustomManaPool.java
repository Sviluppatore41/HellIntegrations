package foxiwhitee.HellIntegrations.integration.botania.client.render.pools;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;
import foxiwhitee.HellIntegrations.HellCore;
import foxiwhitee.HellIntegrations.integration.botania.tile.pools.TileCustomManaPool;
...
public class RenderCustomManaPool  extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
        ...
        texture = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/blocks/botania/" + pool.getName() + ".png");GL11.glPushMatrix();
        GL11.glEnable(3042);
