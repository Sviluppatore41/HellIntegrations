package foxiwhitee.HellIntegrations.integration.botania.client.render.spreaders;

import foxiwhitee.HellIntegrations.HellCore;
import foxiwhitee.HellIntegrations.integration.botania.tile.spreaders.TileCustomSpreader;
...
public class RenderCustomSpreader  extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float ticks) {
        ...
        texture = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/blocks/botania/" + spreader.getName() + ".png");
        GL11.glPushMatrix();
        GL11.glEnable(32826);
