package foxiwhitee.HellIntegrations.integration.botania.integration.avaritia.items;

import foxiwhitee.HellIntegrations.HellCore;
import foxiwhitee.HellIntegrations.config.ContentConfig;
import foxiwhitee.HellIntegrations.integration.botania.flowers.*;
import foxiwhitee.HellIntegrations.integration.botania.integration.avaritia.flower.logic.LogicAsgardandelion;
import foxiwhitee.HellIntegrations.integration.botania.integration.avaritia.flower.logic.LogicHelibrium;
import foxiwhitee.HellIntegrations.integration.botania.integration.avaritia.flower.logic.LogicMidgaran;
import foxiwhitee.HellIntegrations.integration.botania.integration.avaritia.flower.logic.LogicValharin;
...
public class ItemGenerationFlowerCoresAvaritia extends Item implements ICoreGeneratingFlower {
    ...
    public void registerIcons(IIconRegister register) {
        if (ContentConfig.enableAsgardandelions) {
            ...
            icons[0] = register.registerIcon(HellCore.MODID.toLowerCase() + ":botania/cores/generation/" + names[0]);
        }
    }
