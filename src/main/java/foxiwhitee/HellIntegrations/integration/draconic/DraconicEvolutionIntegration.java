package foxiwhitee.HellIntegrations.integration.draconic;
...
import foxiwhitee.HellIntegrations.integration.draconic.blocks.*;
import foxiwhitee.HellIntegrations.integration.draconic.client.render.*;
import foxiwhitee.HellIntegrations.integration.draconic.client.render.armor.RenderArialArmor;
import foxiwhitee.HellIntegrations.integration.draconic.client.render.armor.RenderChaoticArmor;
import foxiwhitee.HellIntegrations.integration.draconic.client.render.effect.SEffectHandler;
import foxiwhitee.HellIntegrations.integration.draconic.client.render.items.*;
import foxiwhitee.HellIntegrations.integration.draconic.entity.EntityArialHeart;
import foxiwhitee.HellIntegrations.integration.draconic.entity.EntityChaoticHeart;
import foxiwhitee.HellIntegrations.integration.draconic.entity.EntityHeart;
import foxiwhitee.HellIntegrations.integration.draconic.event.OnDropEvent;
import foxiwhitee.HellIntegrations.integration.draconic.helpers.IFusionCraftingInventory;
import foxiwhitee.HellIntegrations.integration.draconic.itemBlock.BlockAwakenedDraconiumItemBlock;
import foxiwhitee.HellIntegrations.integration.draconic.itemBlock.BlockChaosItemBlock;
import foxiwhitee.HellIntegrations.integration.draconic.items.*;
import foxiwhitee.HellIntegrations.integration.draconic.items.armors.ArialArmor;
import foxiwhitee.HellIntegrations.integration.draconic.items.armors.ChaoticArmor;
import foxiwhitee.HellIntegrations.integration.draconic.items.capicators.ArialFluxCapicator;
import foxiwhitee.HellIntegrations.integration.draconic.items.capicators.ChaoticFluxCapicator;
import foxiwhitee.HellIntegrations.integration.draconic.items.tools.*;
import foxiwhitee.HellIntegrations.integration.draconic.items.weapons.ArialBow;
import foxiwhitee.HellIntegrations.integration.draconic.items.weapons.ArialSword;
import foxiwhitee.HellIntegrations.integration.draconic.items.weapons.ChaoticBow;
import foxiwhitee.HellIntegrations.integration.draconic.items.weapons.ChaoticSword;
import foxiwhitee.HellIntegrations.integration.draconic.recipes.FusionRecipe;
import foxiwhitee.HellIntegrations.integration.draconic.tile.*;
import foxiwhitee.HellIntegrations.items.DefaultItem;
import foxiwhitee.HellIntegrations.integration.draconic.event.AEventHandler;
import foxiwhitee.HellIntegrations.integration.draconic.event.CommonEventHandler;
import foxiwhitee.HellIntegrations.integration.draconic.event.CEventHandler;
import foxiwhitee.HellIntegrations.utils.helpers.OreDictUtil;
...
import static foxiwhitee.HellIntegrations.ModRecipes.*;
import static foxiwhitee.HellIntegrations.ModRecipes.registerDraconicAssemblerRecipe;
...
public class DraconicEvolutionIntegration implements IIntegration {
    ...
    public static final Block ARIAL_BLOCK = new BaseBlock("arialBlock").setBlockTextureName(HellCore.MODID.toLowerCase() + ":draconic/arialBlock");
    ...
    public void postInit(FMLPostInitializationEvent e) {
        ...
        if (ContentConfig.enableAssembler) {
            ...
            if (ContentConfig.enableStorageCells) {
                registerDraconicAssemblerRecipe(new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 1, 0), 0, 100000,
                ...
                registerDraconicAssemblerRecipe(new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 1, 1), 0, 100000,
                        new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 2, 0),
                ...
                registerDraconicAssemblerRecipe(new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 1, 2), 0, 100000,
                        new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 2, 1),
                ...
                registerDraconicAssemblerRecipe(new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 1, 3), 0, 100000,
                        new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 2, 2),
                ...
                registerDraconicAssemblerRecipe(new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 1, 4), 0, 100000,
                        AEApi.instance().definitions().materials().singularity().maybeStack(64).get(),
                        new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 8, 0),
                        new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 8, 1),
                        new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 8, 2),
                        new ItemStack(foxiwhitee.HellIntegrations.ModItems.CUSTOM_EMPTY_STORAGE_CELLS, 8, 3));
            }
            if (ContentConfig.enableFusion) {
    ...
    public static ResourceLocation getResource(String rs) {
        if (!cachedResources.containsKey(rs))
            cachedResources.put(rs, new ResourceLocation(HellCore.MODID.toLowerCase() + ":" + rs));
