...
public class BlockChaos extends BlockDE {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.icons[0] = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":draconic/chaotic_block");
        this.icons[1] = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":draconic/charged_chaotic_block");
    }
