...
public class BlockFusionCraftingCore extends AEBaseBlock implements ITileEntityProvider, IHudDisplayBlock {
    ...
    public void registerBlockIcons(IIconRegister register) {
        ...
        this.icon[0] = register.registerIcon(HellCore.MODID.toLowerCase() + ":models/fusion_crafting_core");
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        ...
        if (tile != null)
            player.openGui(HellCore.MODID.toLowerCase(), GuiHandlers.fusionCraftingCore, world, x, y, z);
        return true;
    }
