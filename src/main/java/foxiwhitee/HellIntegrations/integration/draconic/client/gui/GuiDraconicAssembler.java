...
import foxiwhitee.HellIntegrations.client.gui.HellBaseGui;
import foxiwhitee.HellIntegrations.client.gui.buttons.NoTextureButton;
import foxiwhitee.HellIntegrations.integration.draconic.container.ContainerDraconicAssembler;
import foxiwhitee.HellIntegrations.integration.draconic.container.slots.DraconicAssemblerSlot;
...
public class GuiDraconicAssembler extends HellBaseGui {
    ...
    public void drawBG(int offsetX, int offsetY, int mouseX, int mouseY) {
        ...
        if (side != 1) {
            bindTexture(HellCore.MODID.toLowerCase(), this.getBackground());
            ...
            bindTexture(HellCore.MODID.toLowerCase(), this.getBackgroundUpgrade());
    ...
    public void drawSlot(DraconicAssemblerSlot slot) {
        ...
        if (level >= 0) {
            ...
            UtilGui.drawTexture(this.guiLeft + slot.xDisplayPosition - 4, this.guiTop + slot.yDisplayPosition - 4, startX, 720, 24, 24, 48, 48, getSizeTexture()[0], getSizeTexture()[1], this, HellCore.MODID.toLowerCase(), this.getBackground());
        }
    }
