...
public class RenderItemDraconicAssembler implements IItemRenderer {
    protected ResourceLocation getTexture() {
        return new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/blocks/draconic/dragonAssembler.png");
    }

    private final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(HellCore.MODID.toLowerCase(), "models/dragon_assembler.obj"));
