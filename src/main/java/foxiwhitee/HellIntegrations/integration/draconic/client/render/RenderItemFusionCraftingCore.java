...
public class RenderItemFusionCraftingCore implements IItemRenderer {
    private final ResourceLocation texture = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/fusion_crafting_core.png");

    private final IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(HellCore.MODID.toLowerCase(), "models/fusion_crafting_core.obj"));
