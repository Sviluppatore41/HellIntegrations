...
public class ModelArialArmor extends ModelBiped {
    ...
    public static final ResourceLocation arial_helm_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ArialHelmet.obj");

    public static final ResourceLocation arial_BODY_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ArialBody.obj");

    public static final ResourceLocation arial_L_ARM_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ArialLeftArm.obj");

    public static final ResourceLocation arial_R_ARM_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ArialRightArm.obj");

    public static final ResourceLocation arial_BELT_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ArialBelt.obj");

    public static final ResourceLocation arial_L_LEG_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ArialLeftLeg.obj");

    public static final ResourceLocation arial_R_LEG_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ArialRightLeg.obj");

    public static final ResourceLocation arial_L_BOOT_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ArialLeftBoot.obj");

    public static final ResourceLocation arial_R_BOOT_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ArialRightBoot.obj");

    public static final ResourceLocation arial_helm_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ArialHelmet.png");

    public static final ResourceLocation arial_BODY_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ArialBody.png");

    public static final ResourceLocation arial_L_ARM_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ArialLeftArm.png");

    public static final ResourceLocation arial_R_ARM_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ArialRightArm.png");

    public static final ResourceLocation arial_BELT_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ArialBelt.png");

    public static final ResourceLocation arial_L_LEG_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ArialLeftLeg.png");

    public static final ResourceLocation arial_R_LEG_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ArialRightLeg.png");

    public static final ResourceLocation arial_L_BOOT_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ArialLeftBoot.png");

    public static final ResourceLocation arial_R_BOOT_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ArialRightBoot.png");
