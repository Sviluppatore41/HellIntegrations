package foxiwhitee.HellIntegrations.integration.draconic.client.render.armor;
...
public class ModelChaoticArmor extends ModelBiped {
    ...
    public static final ResourceLocation chaotic_helm_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ChaoticHelmet.obj");

    public static final ResourceLocation CHAOTIC_BODY_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ChaoticBody.obj");

    public static final ResourceLocation CHAOTIC_L_ARM_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ChaoticLeftArm.obj");

    public static final ResourceLocation CHAOTIC_R_ARM_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ChaoticRightArm.obj");

    public static final ResourceLocation CHAOTIC_BELT_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ChaoticBelt.obj");

    public static final ResourceLocation CHAOTIC_L_LEG_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ChaoticLeftLeg.obj");

    public static final ResourceLocation CHAOTIC_R_LEG_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ChaoticRightLeg.obj");

    public static final ResourceLocation CHAOTIC_L_BOOT_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ChaoticLeftBoot.obj");

    public static final ResourceLocation CHAOTIC_R_BOOT_M = new ResourceLocation(HellCore.MODID.toLowerCase(), "models/armor/ChaoticRightBoot.obj");

    public static final ResourceLocation chaotic_helm_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ChaoticHelmet.png");

    public static final ResourceLocation CHAOTIC_BODY_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ChaoticBody.png");

    public static final ResourceLocation CHAOTIC_L_ARM_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ChaoticLeftArm.png");

    public static final ResourceLocation CHAOTIC_R_ARM_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ChaoticRightArm.png");

    public static final ResourceLocation CHAOTIC_BELT_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ChaoticBelt.png");

    public static final ResourceLocation CHAOTIC_L_LEG_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ChaoticLeftLeg.png");

    public static final ResourceLocation CHAOTIC_R_LEG_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ChaoticRightLeg.png");

    public static final ResourceLocation CHAOTIC_L_BOOT_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ChaoticLeftBoot.png");

    public static final ResourceLocation CHAOTIC_R_BOOT_M_T = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/models/armor/ChaoticRightBoot.png");
