package foxiwhitee.HellIntegrations.integration.draconic.client.render.effect;
...
import foxiwhitee.HellIntegrations.integration.draconic.client.shaders.AlphaShader;
...
public class EffectTrackerFusionCrafting {
    ...
    public void onUpdate(boolean isMoving) {
        ...
        if (this.rand.nextInt(chance) == 0)
            SEffectHandler.spawnFXDirect(new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/particle/particles.png"), new SubParticle(this.world, this.pos));
        ...
        if (this.rand.nextInt(chance * 2 + (int)(this.effectCount * 1.5D)) == 0) {
            ...
            SEffectHandler.spawnFXDirect(new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/particle/particles.png"), new SubParticle(this.world, pos));
        }
