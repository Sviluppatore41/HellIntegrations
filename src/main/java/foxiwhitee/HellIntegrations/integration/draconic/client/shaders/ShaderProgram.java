package foxiwhitee.HellIntegrations.integration.draconic.client.shaders;
...
public class ShaderProgram {
    ...
    public ShaderProgram(String vertexName, String fragmentName) {
        if (vertexName != null) {
            String code = (new Scanner(Objects.<InputStream>requireNonNull(getClass().getClassLoader().getResourceAsStream("assets/" + HellCore.MODID.toLowerCase() + "/shader/" + vertexName + ".vsh")))).useDelimiter("\\A").next();
        ...
        if (fragmentName != null) {
            String code = (new Scanner(Objects.<InputStream>requireNonNull(getClass().getClassLoader().getResourceAsStream("assets/" + HellCore.MODID.toLowerCase() + "/shader/" + fragmentName + ".fsh")))).useDelimiter("\\A").next();
