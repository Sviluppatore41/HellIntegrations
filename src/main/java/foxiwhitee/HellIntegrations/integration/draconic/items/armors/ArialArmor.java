...
import foxiwhitee.HellIntegrations.integration.draconic.client.render.armor.ModelArialArmor;
...
public class ArialArmor extends ItemArmor implements ISpecialArmor, IConfigurableItem, IInventoryTool, IGoggles, IRevealer, ICustomArmor, ICustomUpgradableItem {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.helmIcon = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":arial_helmet");
        this.chestIcon = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":arial_chestplate");
        this.leggsIcon = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":arial_leggings");
        this.bootsIcon = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":arial_boots");
    }
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        if (!ConfigHandler.useOldArmorModel)
            return HellCore.MODID.toLowerCase() + ":textures/models/armor/armorArial.png";
        return (stack.getItem() != DraconicEvolutionIntegration.ARIAL_HELM && stack.getItem() != DraconicEvolutionIntegration.ARIAL_CHEST && stack.getItem() != DraconicEvolutionIntegration.ARIAL_BOOTS) ? HellCore.MODID.toLowerCase() + ":textures/models/armor/arial_layer_2.png" : "draconicadditions:textures/models/armor/arial_layer_1.png";
    }
