package foxiwhitee.HellIntegrations.integration.draconic.items.armors;
...
import foxiwhitee.HellIntegrations.integration.draconic.client.render.armor.ModelChaoticArmor;
import foxiwhitee.HellIntegrations.integration.draconic.helpers.ICustomUpgradableItem;
...
public class ChaoticArmor extends ItemArmor implements ISpecialArmor, IConfigurableItem, IInventoryTool, IGoggles, IRevealer, ICustomArmor, ICustomUpgradableItem {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.helmIcon = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":chaotic_helmet");
        this.chestIcon = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":chaotic_chestplate");
        this.leggsIcon = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":chaotic_leggings");
        this.bootsIcon = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":chaotic_boots");
    }
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        if (!ConfigHandler.useOldArmorModel)
            return HellCore.MODID.toLowerCase() + ":textures/models/armor/armorChaotic.png";
        return (stack.getItem() != DraconicEvolutionIntegration.CHAOTIC_HELM && stack.getItem() != DraconicEvolutionIntegration.CHAOTIC_CHEST && stack.getItem() != DraconicEvolutionIntegration.CHAOTIC_BOOTS) ? HellCore.MODID.toLowerCase() + ":textures/models/armor/chaotic_layer_2.png" : "draconicadditions:textures/models/armor/chaotic_layer_1.png";
    }
