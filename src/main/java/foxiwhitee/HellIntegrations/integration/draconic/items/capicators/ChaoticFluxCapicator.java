package foxiwhitee.HellIntegrations.integration.draconic.items.capicators;
...
import foxiwhitee.HellIntegrations.integration.draconic.items.RFItemBase;
...
public class ChaoticFluxCapicator extends RFItemBase implements ICustomUpgradableItem {
    ...
    public ChaoticFluxCapicator(String name) {
        this.name = name;
        setTextureName(HellCore.MODID.toLowerCase() + ":draconic/" + name);
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.icons[0] = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":draconic/" + name);
    }
