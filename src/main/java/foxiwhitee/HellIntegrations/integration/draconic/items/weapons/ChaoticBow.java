package foxiwhitee.HellIntegrations.integration.draconic.items.weapons;
...
public class ChaoticBow extends ItemBow implements IInventoryTool, IEnergyContainerWeaponItem, IHudDisplayItem, ICustomUpgradableItem {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.itemIcon = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":" + name  + "_standby");
        this.iconArray = new IIcon[bowPullIconNameArray.length];
        for (int i = 0; i < this.iconArray.length; i++)
            this.iconArray[i] = iconRegister.registerIcon(HellCore.MODID.toLowerCase() + ":" + name + "_" + bowPullIconNameArray[i]);
    }
