...
import foxiwhitee.HellIntegrations.integration.draconic.client.render.effect.EffectTrackerFusionCrafting;
import foxiwhitee.HellIntegrations.integration.draconic.client.render.effect.SEffectHandler;
import foxiwhitee.HellIntegrations.integration.draconic.client.render.effect.SParticle;
import foxiwhitee.HellIntegrations.integration.draconic.client.sound.FusionRotationSound;
import foxiwhitee.HellIntegrations.integration.draconic.helpers.Cord3D;
import foxiwhitee.HellIntegrations.integration.draconic.helpers.IFusionCraftingCharger;
import foxiwhitee.HellIntegrations.integration.draconic.helpers.IFusionCraftingInjector;
...
public class TileFusionCraftingCore extends AEBaseTile implements ISidedInventory, IFusionCraftingInventory {
    ...
    public void updateEffects() {
        ...
        if (!this.isCrafting) {
            for (int i = 0; i < 100; i++)
                SEffectHandler.spawnFXDirect(new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/particle/particles.png"), (SParticle)new EffectTrackerFusionCrafting.SubParticle(this.worldObj, (new Cord3D(this.xCoord, this.yCoord, this.zCoord)).add(0.5D, 0.5D, 0.5D)));
            this.effects = null;
        }
    }
    ...
    public void renderEffects(float partialTicks) {
        if (this.effects != null) {
            (Minecraft.getMinecraft()).renderEngine.bindTexture(new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/particle/fusion_particle.png"));
