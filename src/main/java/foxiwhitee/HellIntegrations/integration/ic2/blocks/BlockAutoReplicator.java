...
import foxiwhitee.HellIntegrations.integration.ic2.tile.replicators.TileAutoAdvancedReplicator;
import foxiwhitee.HellIntegrations.integration.ic2.tile.replicators.TileAutoNanoReplicator;
import foxiwhitee.HellIntegrations.integration.ic2.tile.replicators.TileAutoQuantumReplicator;
import foxiwhitee.HellIntegrations.integration.ic2.tile.replicators.TileAutoReplicator;
import ic2.core.IC2;
...
public class BlockAutoReplicator extends AEBaseBlock implements ITileEntityProvider {
    ...
    public void registerBlockIcons(IIconRegister register) {
        String name = HellCore.MODID.toLowerCase() + ":ic2/" + this.name;
        for (int a = 0; a < 2; a++) {
            for (int s = 0; s < 6; s++) {
                int subIndex = a * 6 + s;
