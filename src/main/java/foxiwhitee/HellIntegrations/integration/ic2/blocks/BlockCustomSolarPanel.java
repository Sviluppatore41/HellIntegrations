...
import foxiwhitee.HellIntegrations.integration.ic2.client.gui.GuiCustomSolarPanel;
import foxiwhitee.HellIntegrations.integration.ic2.container.ContainerCustomSolarPanel;
import foxiwhitee.HellIntegrations.integration.ic2.helpers.ISpecialSintezatorPanel;
import foxiwhitee.HellIntegrations.integration.ic2.tile.generators.panels.*;
...
public class BlockCustomSolarPanel extends AEBaseTileBlock implements ISpecialSintezatorPanel {
    ...
    {
        blockIcon = register.registerIcon( HellCore.MODID.toLowerCase()+ ":panels/" + this.getUnlocalizedName().replace("tile.", "") + "Side");
        topIcon = register.registerIcon(HellCore.MODID.toLowerCase()+ ":panels/" + this.getUnlocalizedName().replace("tile.", "") + "Top");
        downIcon = register.registerIcon(HellCore.MODID.toLowerCase()+ ":panels/bottom");
    }
