...
import foxiwhitee.HellIntegrations.integration.ic2.client.gui.GuiSynthesizer;
import foxiwhitee.HellIntegrations.integration.ic2.container.ContainerSynthesizer;
import foxiwhitee.HellIntegrations.integration.ic2.tile.TileSynthesizer;
...
public final class BlockSynthesizer extends AEBaseBlock implements ITileEntityProvider {
    public BlockSynthesizer(String name) {
        super(Material.iron);
        setBlockName(name);
        setBlockTextureName(HellCore.MODID.toLowerCase() + ":ic2/" + name);
        this.isOpaque = false;
    }
