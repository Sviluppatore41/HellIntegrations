...
import foxiwhitee.HellIntegrations.integration.ic2.container.ContainerAdvancedScanner;
import foxiwhitee.HellIntegrations.integration.ic2.tile.TileAdvancedScanner;
...
public class GuiAdvancedScanner extends GuiContainer {
    ...
    protected ResourceLocation getBackground(String name) {
        return new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/gui/gui_" + name +  ".png");
    }
}
