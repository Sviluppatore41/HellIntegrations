...
import foxiwhitee.HellIntegrations.integration.ic2.container.ContainerQuantumMatterUnifier;
...
public class GuiQuantumMatterUnifier extends GuiContainer {
    private final ResourceLocation texture = new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/gui/gui_matter_unifier.png");
