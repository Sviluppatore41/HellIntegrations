package foxiwhitee.HellIntegrations.integration.nei.draconic.fusion;
...
import foxiwhitee.HellIntegrations.integration.draconic.client.gui.modulargui.GuiEffectRenderer;
...
public class GuiFusionCraftingHandler extends TemplateRecipeHandler {
    ...
    public String getGuiTexture() {
        return HellCore.MODID.toLowerCase() + ":textures/gui/fusioncrafting_nei.png";
    }
