package foxiwhitee.HellIntegrations.integration.thaumcraft.client.gui;

import appeng.api.storage.ITerminalHost;
import foxiwhitee.HellIntegrations.HellCore;
import foxiwhitee.HellIntegrations.api.config.Buttons;
import foxiwhitee.HellIntegrations.client.gui.buttons.NoTextureAEButton;
import foxiwhitee.HellIntegrations.client.gui.terminals.GuiPatternTerminal;
import foxiwhitee.HellIntegrations.api.config.CustomAESetings;
...
public class GuiPartAlchemicalConstructionPatternTerminal extends GuiPatternTerminal {
    ...
    private void drawVis(CrucibleRecipe recipe, int mouseX, int mouseY) {
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation(HellCore.MODID.toLowerCase(), "textures/" + this.getBackground()));
        GL11.glEnable(3042);
