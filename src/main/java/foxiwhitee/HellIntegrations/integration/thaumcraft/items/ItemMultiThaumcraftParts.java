...
import foxiwhitee.HellIntegrations.integration.thaumcraft.parts.EnumPartsThaumcraftTerminals;
import foxiwhitee.HellIntegrations.items.part.NameResolver;
...
public class ItemMultiThaumcraftParts extends AEBaseItem implements IPartItem, IItemGroup {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        for(Map.Entry<Integer, EnumPartsWithVariant> part : this.getRegistered().entrySet()) {
            String tex = HellCore.MODID.toLowerCase() + ":ae2/terminals/" + this.getName(new ItemStack(this, 1, (Integer)part.getKey())).toLowerCase();
