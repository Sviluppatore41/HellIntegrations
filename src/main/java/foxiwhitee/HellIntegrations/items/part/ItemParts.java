package foxiwhitee.HellIntegrations.items.part;
...
import foxiwhitee.HellIntegrations.parts.EnumParts;
...
public class ItemParts extends AEBaseItem implements IPartItem, IItemGroup {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        for (Map.Entry<Integer, EnumPartsWithVariant> part : this.registered.entrySet()) {
            String tex = HellCore.MODID.toLowerCase() + ":" + getName(new ItemStack((Item)this, 1, ((Integer)part.getKey()).intValue())).toLowerCase();
