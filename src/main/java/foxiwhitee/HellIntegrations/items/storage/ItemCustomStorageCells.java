...
import foxiwhitee.HellIntegrations.utils.cells.ICustomStorageCell;
...
public class ItemCustomStorageCells extends Item implements ICustomStorageCell {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        for(int i = 0; i < suffixes.length; ++i) {
            this.icons[i] = iconRegister.registerIcon("HellIntegrations:storageCells/storageCell" + suffixes[i]);
        }
