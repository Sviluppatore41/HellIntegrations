...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        if (ContentConfig.enableInterfaces) {
            ...
            RegisterUtils.findClasses("foxiwhitee.hellmod.tile.interfaces", TileEntity.class).forEach(RegisterUtils::registerTile);
        }
        ...
        if (ContentConfig.enableMolecularAssemblers) {
            ...
            RegisterUtils.findClasses("foxiwhitee.hellmod.tile.assemblers", TileEntity.class).forEach(RegisterUtils::registerTile);
        }
        if (ContentConfig.enableEnergyCells) {
            ...
            RegisterUtils.findClasses("foxiwhitee.hellmod.tile.energycell", TileEntity.class).forEach(RegisterUtils::registerTile);
        }
        ...
        if (ContentConfig.enableMEFluid) {
            ...
            RegisterUtils.findClasses("foxiwhitee.hellmod.tile.fluid", TileEntity.class).forEach(RegisterUtils::registerTile);
        }
    }
}
